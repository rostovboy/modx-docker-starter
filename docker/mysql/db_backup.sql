...
CREATE TABLE `modx_access_actiondom` (
  ...
  `principal_class` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'modPrincipal',
...
CREATE TABLE `modx_access_policies` (
  ...
  `lexicon` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'permissions',
  PRIMARY KEY (`id`),
...
CREATE TABLE `modx_actiondom` (
  ...
  `container` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `rule` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `value` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `constraint` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_actions` (
  ...
  `lang_topics` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `assets` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `help_url` text COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `modx_actions_fields` (
  ...
  `form` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_class_map` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `class` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `parent_class` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `name_field` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'name',
  `path` tinytext COLLATE utf8mb4_unicode_ci,
  `lexicon` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'core:resource',
  PRIMARY KEY (`id`),
...
CREATE TABLE `modx_dashboard_widget` (
  ...
  `size` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'half',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  KEY `type` (`type`),
  KEY `namespace` (`namespace`),
...
INSERT INTO `modx_dashboard_widget_placement` VALUES (1,3,0),(1,4,1);
...
CREATE TABLE `modx_extension_packages` (
  ...
  `table_prefix` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `service_class` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `modx_manager_log` (
  ...
  `item` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `modx_manager_log` VALUES (1,1,'2023-12-18 20:51:42','login','modContext','mgr'),(2,1,'2023-12-19 06:12:23','dashboard_update','modDashboard','1'),(3,1,'2023-12-19 06:14:12','save_profile','modUser','1'),(4,1,'2023-12-19 06:14:36','change_profile_password','modUser','1'),(5,1,'2023-12-23 13:02:24','change_profile_password','modUser','1');
...
CREATE TABLE `modx_media_sources` (
  ...
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE utf8mb4_unicode_ci,
  `class_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sources.modFileMediaSource',
...
CREATE TABLE `modx_media_sources_elements` (
  ...
  `object_class` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'modTemplateVar',
...
INSERT INTO `modx_session` VALUES ('076f47a76db1cb1f2eac43932ef3fa38',1702932702,'modx.user.contextTokens|a:1:{s:3:\"mgr\";i:1;}modx.mgr.user.token|s:52:\"modx6580b0a5488d58.26563722_16580b0dea62a11.69970985\";modx.mgr.session.cookie.lifetime|i:604800;modx.mgr.user.config|a:0:{}');
...
CREATE TABLE `modx_site_content` (
  ...
  `link_attributes` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `menutitle` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `donthit` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `privateweb` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `privatemgr` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `content_dispo` tinyint(1) NOT NULL DEFAULT '0',
  `hidemenu` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `class_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'modDocument',
  `context_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'web',
...
CREATE TABLE `modx_site_htmlsnippets` (
  ...
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Chunk',
  ...
  `static_file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `category` (`category`),
  KEY `locked` (`locked`),
...
CREATE TABLE `modx_site_templates` (
  ...
  `description` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Template',
  `editor_type` int(11) NOT NULL DEFAULT '0',
  `category` int(11) NOT NULL DEFAULT '0',
  `icon` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `modx_transport_providers` VALUES (1,'modx.com','The official MODX transport provider for 3rd party components.','https://rest.modx.com/extras/','','','2023-03-07 07:16:34',NULL,1,10,'');
...
INSERT INTO `modx_user_attributes` VALUES (1,1,'Администратор по умолчанию','admin@localhost.lo','','',0,0,0,1,0,1702932702,0,'076f47a76db1cb1f2eac43932ef3fa38',0,0,'','','','','','','','','',NULL);
...
CREATE TABLE `modx_users` (
  ...
  `class_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'modUser',
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `remote_key` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remote_data` text COLLATE utf8mb4_unicode_ci,
  `hash_class` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'hashing.modNative',
...
INSERT INTO `modx_users` VALUES (1,'developer','$2y$10$iLYVIjkrmzaKaqbHi.5h0uhRa0jAHRimGeseXdE3GrnROWbCSlP4O','','modUser',1,NULL,NULL,'hashing.modNative','2ea716e912b761bf27382d50facb0aa8',1,NULL,1,1702932666);
...
INSERT INTO `modx_workspaces` VALUES (1,'Default MODX workspace','{core_path}','2023-12-18 20:50:53',1,NULL);
...
-- Dump completed on 2023-12-23 13:10:41
